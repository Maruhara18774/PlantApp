...
class _DetailHisState extends State<DetailHis> {
  ...
  AddNotification(String idOrder) async {
    ...
    await NotificationFirebase()
        .Add(idOrder, "Đơn hàng " + idOrder + " đã được hủy thành công.");
  }
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: Padding(
                      ...
                      child: this.order != null
                          ? Text(
                              "Tổng cộng: " + this.order!.tong.toString(),
                              textAlign: TextAlign.end,
                            )
                          : Text("Tổng cộng: 0")),
                ),
                ...
                SizedBox(height: 5),
                this.order != null
                    ? Text("Ngày đặt:   " + this.order!.ngayDat!)
                    : Text(""),
                SizedBox(height: 5),
                this.order != null
                    ? Text("Tình trạng:   " + getStatus(this.order!.tinhTrang!))
                    : Text(""),
                SizedBox(height: 5),
