...
KhachHang currentUserGlb = new KhachHang(uid: '');
List<SanPham> cartSanPhamGlb = List<SanPham>.empty(growable: true);
List<ChiTietGioHang> cartCTGioHang = List<ChiTietGioHang>.empty(growable: true);